...
enum object_types 
{
	...
	PARALLEL_BARS,
	PANEL_BORDER, PANEL_MIDDLE, PANEL_CORNER, PANEL_DIAGONAL, PANEL_STRIP,
	PANEL_HALF_BORDER1, PANEL_HALF_BORDER2, PANEL_MIDDLE_CORNER,
	TIGHT_ROPE,
	LASER_HEAD, LASER_HEAD_BASE, LASER_HEAD_TENTACLE,
	HYDRA, HYDRA_MISSLE,
	ENEMY_SUB_MARINE, ENEMY_SUB_MARINE_MIP, SUB_MARINE_MISSLE,
	FROG_MAN, FROG_MAN_HARPOON,
	FISH_EMITTER,
	KAYAK, KAYAK_LARA,

	CUSTOM_SPRITE_SEQUENCE,

	BRIDGE_TILT3, BRIDGE_TILT4, BRIDGE_CUSTOM,
	ROBOT_CLEANER, ROBOT_STAR_WARS,
	MECH_WARRIOR, MECH_WARRIOR_LARA,
	UW_PROPULSOR, UW_PROPULSOR_LARA,
	MINE_CART, MINE_CART_LARA,

	CLASSIC_ROLLINGBALL,

	NEW_SLOT6, NEW_SLOT7, NEW_SLOT8, NEW_SLOT9, NEW_SLOT10, NEW_SLOT11, NEW_SLOT12, NEW_SLOT13,
	NEW_SLOT14, NEW_SLOT15, NEW_SLOT16, NEW_SLOT17, NEW_SLOT18,
